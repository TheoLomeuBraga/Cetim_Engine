...
public:
    ...
    void atualisar()
    {
       ...
       if (is_above() && lua_function.L != NULL)
        ...
        text_obj->pegar_componente<render_texto>()->font = ManuseioDados::carregar_fonte("Fonts/OpenSans.ttf");
    }
...
void test_ui(objeto_jogo *father, LuaFunctionWrapper lw)
{
    ...
    uic->id = "test_button";
    ui_style style;
    style.text_font = ManuseioDados::carregar_fonte("Fonts/OpenSans.ttf");
