...
function COLLIDE(collision_info)
    if enable then
        ...
        if obj_colide.components ~= nil and obj_colide.components[components.lua_scripts] ~= nil and obj_colide.components[components.lua_scripts]:has_script("game_scripts/player/charter") then
