...
function UPDATE()
    ...
    inputs = {
        ...
        action_1 = keys_axis:get_input(input_devices.mouse,"left") + (keys_axis:get_input_joystick(1,"rt_axis") + 1),
        action_2 = keys_axis:get_input(input_devices.mouse,"right") + (keys_axis:get_input_joystick(1,"lt_axis") + 1),
