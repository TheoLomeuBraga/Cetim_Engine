...
function UPDATE()
    ...
    print(0,keys_axis:get_input_joystick(1,"y"),0)
    print(keys_axis:get_input_joystick(1,"x"),0,keys_axis:get_input_joystick(1,"b"))
    print(0,keys_axis:get_input_joystick(1,"a"),0)
