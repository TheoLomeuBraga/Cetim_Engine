...
function sceanes_db.test3:load()
    ...
    create_collision_mesh(this_sceane.objects_layesrs.background_3D,pos2,Vec3:new(0,0,0),Vec3:new(5,1,5),2,{mat},{mesh_location:new("resources/3D Models/cube.gltf","Cube")},false)
