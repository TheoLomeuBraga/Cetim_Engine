...
function sceanes_db.test:load()
    ...
    --create_text(this_sceane.objects_layesrs.hud,true,Vec3:new(-0.75,0.75,0.9),Vec3:new(0,0,0),Vec3:new(0.05,0.05,0.05),mat,3,"\\033[32mHello, \\033[31mworld!\\033[0m\n","resources/Fonts/Glowworm Regular.json")
