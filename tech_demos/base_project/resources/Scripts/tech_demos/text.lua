...
function demo:START(layers)
    ...
    create_text(layers.cenary,false,{x=1,y=1,z=1},{x=0,y=0,z=0},{x=0.1,y=0.1,z=0.1},mat,2,"hello world \nim Théo's game engine","resources/Fonts/Glowworm Regular.json")

    mat.color = {r=1,g=0,b=0,a=1}
    create_text(layers.cenary,false,{x=2,y=2,z=2},{x=0,y=0,z=0},{x=0.1,y=0.1,z=0.1},mat,2,"hello world \nim Théo's game engine","resources/Fonts/Glowworm Regular.json")
end
