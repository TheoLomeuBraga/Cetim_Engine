...
function demo:START(layers)
    ...
    --demo.text1 = create_text(layers.hud,true,{x=-1,y=0.8,z=0},{x=0,y=0,z=0},{x=0.1,y=0.1,z=0.1},mat,1,"just test the buttons",font)
    demo.text1 = create_text(layers.hud,true,{x=-1,y=-0.2,z=0},{x=0,y=0,z=0},{x=0.1,y=0.1,z=0.1},mat,4,"just test the buttons",font)
