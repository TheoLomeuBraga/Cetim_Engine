...
local assets_needed = {
    ...
    new_asset_list_element(asset_types.scene_3D,"resources/Levels/3D/hub/test_basic_nav_mesh.gltf"),
...
function level:START()
    ...
    coroutine.yield()
    level.scene_3D_data = get_scene_3D("resources/Levels/3D/hub/test_basic_nav_mesh.gltf")
    ...
    global_data.level_animation_data = {path="resources/Levels/3D/hub/test_basic_nav_mesh.gltf",parts_ptr_list=scene_data.parts_ptr_list}
