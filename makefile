...
ifeq ($(OS),Windows_NT)
	...
	LIBS_ENGINE = -L./libs/x86_64/windows -lz -lboost_serialization -lRecast -lDetour -lDetourCrowd -lglfw3 -lglew32 -lopengl32 -lbox2d -lfreetype -lBulletDynamics -lBulletCollision -lLinearMath -lSDL3 -lSDL3_mixer
	ifeq ($(JIT),0)
...
ifeq ($(OS),Linux)
	...
	SRC_ENGINE = ./src/Cetim_Engine/TMP.cpp $(SRC_IMGUI)
	LIBS_ENGINE = -L./libs/x86_64/linux -lz -lboost_serialization -lRecast -lDetour -lDetourCrowd -lglfw -lGLEW -lGL -lGLU -lfreetype -lbox2d -lsfml-network -lsfml-system -lBulletDynamics -lBulletCollision -lLinearMath  -lSDL3 -lSDL3_mixer
	ifeq ($(JIT),0)
		LIBS_ENGINE += -llua -DLUA_NUMBER=float
	endif
	ifeq ($(JIT),1)
